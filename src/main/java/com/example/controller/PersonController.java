...
public class PersonController {
	 ...
	 */
	@GetMapping("/{id}")
	public ResponseEntity<Person> find(@PathVariable("id") Long code) throws BusinessException {
	 ...
	 */
	@PostMapping()
	public ResponseEntity<Person> save(@RequestBody() @Valid Person person) throws BusinessException {
